        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-6">
                <div class="page-title-content">
                    <h3>NFT Project</h3>
                    <p class="mb-2">List here your NFT<strong> Project</strong><br>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xxl-6 col-xl-6 col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data" id="listingForm">
                            @csrf
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label class="form-label" for="projectNameInput">Project Name</label>
                                    <input class="form-control" name="projectName" placeholder="Project Name" type="text" required maxlength="25" id="projectNameInput" value="{{ old('projectName') }}">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group form-group">
                                        <div class="custom-file">
                                            <label class="custom-file-label" for="inputGroupFile01">Choose project image <strong>(NO BANNER)</strong></label>
                                            <input type="file" name="thumbnail" id="inputGroupFile01" accept="image/*" onchange="loadFile(event)">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="number" class="form-control" id="traits" name="traits" placeholder="Different Traits amount" step="1" value="{{ old('traits') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <hr>
                                    <div class="form-group mt-3">
                                        <label class="form-label" for="floorPrice">Floor Price</label>
                                        <input type="number" class="form-control" id="floorPrice" name="floorPrice" placeholder="Current Floor-price" step="0.00001" value="{{ old('floorPrice') }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <hr>
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="roadmap" name="roadmap" cols="30" rows="5" maxlength="4000">{{ old('roadmap') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <hr>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="volumeTxt" name="volume" placeholder="Volume traded (ETH)" step=".0001" value="{{ old('volume') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <hr>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="twitterNameInput" name="twitterName" placeholder="Twitter username (no / allowed)" required value="{{ old('twitterName') }}">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <hr>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="marketplaceLink" name="marketplaceLink" placeholder="Marketplace link" required value="{{ old('marketplaceLink') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        Banner, Section or other promotion? Check <a href="{{ url('prices') }}" target="_blank">our prices</a> (new tab)
                                    </div>
                                </div>
                                <hr>
                                <div class="mt-3">
                                    <button class="btn btn-primary w-100 mt-3 mt-sm-4" type="submit">List project</button>
                                </div>
                        </form>
                    </div>
                </div>
