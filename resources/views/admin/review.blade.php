            ...
            <div class="col-12">
                <div class="intro mb-4">
                    <div class="intro-content">
                        ...
                        <a href="{{ route('admin.db', ['ww' => 'Jelmer01']) }}" class="btn btn-success float-end">DB Aanpassen</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        ...
        <ul class="list-unstyled">
            ...
            <li class="single-tab-list d-flex align-items-center">
                ...
                <div class="activity-content ml-4">
                    <h5>{{ $drop->name }}</h5>
                    <form action="{{ route('admin.update-drop-status') }}" method="GET">
                        <input type="hidden" name="id" value="{{ base64_encode($drop->id) }}">
                        <div class="row">
                            <div class="col-2">
                                <label>Twitter followers:</label>
                            ...
                            <div class="col-2">
                                <label>Hyped number:</label>
                                <input type="text" value="" name="hypedNumber">
                            </div>
                            <div class="col-2">
                                <button type="submit" style="background-color:green;color:white;">Update & Accept</button>
                                <a href="{{ route('admin.delete-drop', ['id' => base64_encode($drop->id)]) }}" style="background-color:red;color:white;">Delete</a>
            ...
            <li class="single-tab-list d-flex align-items-center">
                ...
                <div class="activity-content ml-4">
                    <h5>{{ $project->name }}</h5>
                    <form action="{{ route('admin.update-project-status') }}" method="GET">
                        <input type="hidden" name="id" value="{{ base64_encode($project->id) }}">
                        <div class="row">
                            <div class="col-2">
                                <label>Floorprice:</label>
                            ...
                            <div class="col-2">
                                ...
                                <input type="text" value="{{ $project->twitterFollowerNumber }}" name="twitterFollowerNumber">
                            </div>
                            <div class="col-2">
                                <label>Traits:</label>
                                <input type="text" value="{{ $project->traits }}" name="traits" required>
