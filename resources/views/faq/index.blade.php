    ...
    <div id="faqs" class="container">
        ...
        <div id="faqSection" class="fullwidth-container">
            ...
            <div>
                ...
                <div class="faq-content">
                    <p>To list your own NFT drop, you can click <a href="{{ route('drops.create') }}">here</a>. We have a user-friendly interface that guides you through the listing process, making it easy for creators to showcase their NFT projects. Additionally, you can list your NFT project by clicking <a href="{{ route('projects.create') }}">here</a>.</p>
                </div>
                <button class="collapsible">What is the difference between a project and a drop?</button>
                <div class="faq-content">
                    <p><strong>Drop:</strong> A drop refers to an upcoming NFT release. It represents projects that are scheduled to launch in the future. Drops generate excitement and anticipation within the NFT community as collectors prepare to acquire new and unique digital assets.</p>
