...
$expected_fields = ['projectName', 'projectDescription', 'floorPrice', 'blockchain', 'traits', 'roadmap', 'volume', 'royality', 'supply', 'teamAmount', 'twitterName', 'discordLink', 'websiteLink', 'signature', 'marketplaceLink'];
$missing_fields = array_filter($expected_fields, function($field) { return !isset($_POST[$field]); });
