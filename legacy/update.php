...
$dropParam = request_string($_GET, 'drop', 'none');
$projectParam = request_string($_GET, 'project', 'none');
...
if (!$hasSelection) {
    ...
    $nft = [
        ...
        'thumbnail' => 'img/content/auction_2.jpg',
        'blockchain' => 'ethereum',
    ];
} else {
    if ($dropParam !== 'none') {
        $dropId = decoded_id($dropParam);

        if ($dropId === null) {
            redirect_to('update.php');
        }

        $getNft = $conn->prepare('SELECT * FROM projects WHERE id = :id');
        $getNft->execute([':id' => $dropId]);
        $nft = $getNft->fetch();
    }

    if ($projectParam !== 'none') {
        $projectId = decoded_id($projectParam);

        if ($projectId === null) {
            redirect_to('update.php');
        }

        $getNft = $conn->prepare('SELECT * FROM projectsExist WHERE id = :id');
        $getNft->execute([':id' => $projectId]);
        $nft = $getNft->fetch();
    }
                            ...
                            <div class="col-12">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" class="form-control" id='projectNameInput' name="projectName"
                                           ...
                                           value="<?php echo $nft['name']; ?>" maxlength="25">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mt-3">
                            ...
                            <div class="col-12">
                                <div class="form-group mt-3">
                                    ...
                                    <select name="blockchain" id="selectBlockchain">
                                        <option
                                            value="ethereum" <?php if ($nft['blockchain'] == 'ethereum') { ?> selected<?php } ?>>
                                            Ethereum
                                        </option>
                                        <option
                                            value="solana" <?php if ($nft['blockchain'] == 'solana') { ?> selected<?php } ?>>
                                            Solana
                                        </option>
                                        <option
                                            value="polygon" <?php if ($nft['blockchain'] == 'polygon') { ?> selected<?php } ?>>
                                            Polygon
                                        </option>
                                        <option
                                            value="cardano" <?php if ($nft['blockchain'] == 'cardano') { ?> selected<?php } ?>>
                                            Cardano
                                        </option>
                                        <option
                                            value="avalanche" <?php if ($nft['blockchain'] == 'avalanche') { ?> selected<?php } ?>>
                                            Avalanche
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                               id="inlineRadio1"
                                               value="Fun" <?php if ($nft['category'] == 'Fun') { ?> checked<?php } ?>>
                                        <label class="form-check-label" for="inlineRadio1">Fun</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                               id="inlineRadio2"
                                               value="Metaverse" <?php if ($nft['category'] == 'Metaverse') { ?> checked<?php } ?>>
                                        <label class="form-check-label" for="inlineRadio2">Metaverse</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                               id="inlineRadio3"
                                               value="Artwork" <?php if ($nft['category'] == 'Artwork') { ?> checked<?php } ?>>
...
(summary of your roadmap)
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="float" class="form-control" id='royality' name="royality"
                                           placeholder="Royalty fee (%)" value="<?php echo $nft['royality']; ?>"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control" id='supply' name='supply'
                                           placeholder="NFT Supply (example 3333)" value="<?php echo $nft['supply']; ?>"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control" id='teamAmount' name="teamAmount"
                                           placeholder="Team size " value="<?php echo $nft['teamAmount']; ?>"
                                           required="required">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id='twitterNameInput' name="twitterName"
                                           placeholder="Twitter username" value="<?php echo $nft['twitterName']; ?>"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id='discordNameInput' name="discordLink"
                                           placeholder="Discord invite link" value="<?php echo $nft['discordLink']; ?>"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id='websiteLinkInput' name="websiteLink"
                                           placeholder="Website link" value="<?php echo $nft['websiteLink']; ?>"
                                           required="required">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group mt-3">
                                    <input type="email" class="form-control" id='emailContact' name="emailContact"
                                           ...
                                           value="<?php echo $nft['emailContact']; ?>"
                                           maxlength="70">
                                    ...
                                    <div class="form-group mt-3">
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="promotionBox2">Update drop +
                                                Hypednumber, followers, discord members check.
                            ...
                            <div class="col-12">
                                ...
                                <button class="btn btn-primary w-100 mt-3 mt-sm-4" type="submit" id="btn-connect">Update
                                    Drop
                                </button>
                            </div>
                            <div class="col-12">
                                ...
                                <div class="alert alert-primary" role="alert" id='walletRequiredMessage'
                                    ...
                                    <a href='https://twitter.com/NFTGenie' target="_blank">@DropCalendarNFT </a>for our
                                    twitter
                                </div>
                ...
                <?php } elseif ($projectParam !== 'none') { ?>
                    <form class="item-form card no-hover" id='listingForm' action='updateProjProc.php' method='POST'
                          enctype="multipart/form-data">
                        <div class="row">
                            <input type='hidden' name='id' value="<?php echo $nft['id']; ?>">
                            <div class="col-12">
                                <div class="form-group mt-3">
                                    <input type="text" class="form-control" id='projectNameInput' name="projectName"
                                           placeholder="Project name" value='<?php echo $nft['name']; ?>'
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group mt-3">
                                    <input type="number" class="form-control" id='traits' name="traits"
                                           value='<?php echo $nft['traits']; ?>' placeholder="Diffrent Traits amount"
                                           step="1">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group mt-3">
                                    <input type="number" class="form-control" id='floorPrice' name="floorPrice"
                                           value='<?php echo $nft['floorPrice']; ?>' placeholder="Current Floor-price"
                                           step="0.00001">
                                </div>
                            </div>
...
(summary of your roadmap)
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" id='volumeTxt' name="volume"
                                           value='<?php echo $nft['volume']; ?>' placeholder="Volume traded (ETH)"
                                           step=".0001">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <input type="float" class="form-control" id='royality' name="royality"
                                           value='<?php echo $nft['royality']; ?>' placeholder="Royalty fee (%)"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" id='supply' name='supply'
                                           value='<?php echo $nft['supply']; ?>' placeholder="NFT Supply (example 3333)"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <input type="number" class="form-control" id='teamAmount' name="teamAmount"
                                           value='<?php echo $nft['teamAmount']; ?>' placeholder="Team size "
                                           required="required">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id='twitterNameInput' name="twitterName"
                                           value='<?php echo $nft['twitterName']; ?>' placeholder="Twitter username"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id='discordNameInput' name="discordLink"
                                           value='<?php echo $nft['discordLink']; ?>' placeholder="Discord invite link"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id='websiteLinkInput' name="websiteLink"
                                           value='<?php echo $nft['websiteLink']; ?>' placeholder="Website link"
                                           required="required">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" id='marketplaceLink' name="marketplaceLink"
                                           value='<?php echo $nft['marketplaceLink']; ?>' placeholder="Marketplace link"
                                           required="required">
                                </div>
                            </div>
                            <input type="hidden" id='signature' name='signature' value=''>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="form-group mt-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="promotionBox"
                                                   id="promotionBox2" value="promote2" checked>
                                            <label class="form-check-label" for="promotionBox2">Update project +
                                                Hypednumber, followers, discord members check.
                                                <strong id='listingPrice'> FREE</strong></label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <button class="btn w-100 mt-3 mt-sm-4" type="submit" id="btn-connectProj">Update
                                    project
                                </button>
                            </div>
                            <div class="col-12">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select name="drop" id="selectBlockchain">
                                ...
                                <?php foreach ($drops as $drop) { ?>
                                    <option
                                        value="<?php echo base64_encode($drop['id']); ?>"><?php echo $drop['name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group mt-3">
                            ...
                            <select name="project" id="selectBlockchain">
                                ...
                                <?php foreach ($projects as $project) { ?>
                                    <option
                                        value="<?php echo base64_encode($project['id']); ?>"><?php echo $project['name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
