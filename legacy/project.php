                                ...
                                <ul class="list-unstyled">
                                    <li class="price d-flex justify-content-between">
                                        <h4 style="color: #adacad;">Total Trading Volume: <strong
                                                class="text-primary"><?php echo $project['volume'];
                                                if ($project['ethChoice'] === 'eth') {
                                                    echo 'ETH';
                                                }
                                                if ($project['ethChoice'] === 'matic') {
                                                    echo 'MATIC';
                                                }
                                                if ($project['ethChoice'] === 'solana') {
                                                    echo 'SOL';
                                                } ?> </strong></h4>
                                        <span></span>
                                    </li>
                                    ...
                                    <li class="price d-flex justify-content-between">
                                        <h4 style="color: #adacad;">Marketplace Link:
                                            <strong class="text-primary">
                                                <a href="<?php echo $project['marketplaceLink']; ?>">Visit
                                                    Marketplace</a>
                                            </strong>
                                        </h4>
                                    </li>
