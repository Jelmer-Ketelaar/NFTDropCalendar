                        ...
                        <form action="listingProces.php" method="POST" enctype="multipart/form-data" id="listingForm">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    ...
                                    <input class="form-control" name="projectName" type="text" required="required"
                                           maxlength="50" id="projectNameInput">
                                </div>
                                <div class="col-12">
                                    <div class="form-group mt-3">
                                        <label class="form-label" for="projectShortDesInput">Project Description</label>
                                        <textarea class="form-control" id="projectShortDesInput"
                                                  name="projectDescription" placeholder="Description about the project"
                                                  maxlength="750" cols="30" required="required" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group mt-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group form-group">
                                        <div class="custom-file">
                                            ...
                                            <input type="file" name="thumbnail" id="inputGroupFile01" accept="image/*"
                                ...
                                <div class="col-12">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="datetime-local" id="birthdaytime" name="dropDate"
                                               required="required">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="number" class="form-control" id="traits" name="traits"
                                               placeholder="Different Traits amount" step="1" required="required">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="roadmap">Roadmap:</label>
                                        <textarea class="form-control" id="roadmap" name="roadmap"
                                                  placeholder="Q1: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do Q2: eiusmod tempor incididunt ut labore et dolore magna aliqua Q3: enim ad minim veniam, quis nostrud exercitation ullamco Q4: laboris nisi ut aliquip ex ea commodo consequat"
                                                  cols="30" rows="5" maxlength="4000" required="required"></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <hr>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="mintPrice" name="mintPrice"
                                               placeholder="Mint Price (ETH)" step=".0001" required="required">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <hr>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="royality" name="royality"
                                               placeholder="Royalty fee (%)" required="required">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <br>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="twitterNameInput" name="twitterName"
                                               placeholder="Twitter username (NO LINKS)" required="required">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <hr>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group mt-3"
                                        ...
                                        <h5 style="margin:4px; text-align:center;">Hype up/boost your Project +90.000
                                            views!</h5>
                                        ...
                                        <div class="form-check form-check-inline"
                                            ...
                                            <label class="form-check-label" for="promotionBox1">
                                                <p style="text-align:center;">Homepage promo, Listpage promo, Twitter
                                                    Page Pin,<br>1 Week Full Promo, <strong>340%</strong> more hype on
                                                    your project</p>
                                            </label>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="alert alert-primary" role="alert" id="walletRequiredMessage"
                                    ...
                                    <a href="https://twitter.com/DropCalendarNFT" target="_blank">@DropCalendarNFT </a>for
                                    our twitter
                                </div>
