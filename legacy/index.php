                    ...
                    <a href="nft.php?id=<?php echo base64_encode($banner['id']); ?>" target="_blank">
                        <div class="intro-slider">
                            <div class="slider-item">
                                ...
                                <img alt="<?php echo $banner['name'] ?>" class="image-fluid rounded" id="image-fluid"
                                     style="height: 350px;" src="<?php echo($banner['thumbnail']) ?>">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="swiper-container">
              ...
              25px 25px rgba(253, 156, 46, 0.1);">
                                    <img alt="<?php echo $project['name'] ?>" class="img-fluid card-img-top"
                                    ...
                                    <div class="card-body" style="background-color: inherit;">
                                        ...
                                        <div class="card-bottom d-flex justify-content-between">
                                                <span><img src='img/extern_logo/twitter_logo.png'
                                                           style='width:40px;'
                                                           alt"twitter"> <?php echo $project['twitterFollowerNumber']; ?></span>
                                            <span><img
                                                    src='img/extern_logo/crypto/<?php echo $project['blockchain']; ?>.png'
                                                    style='width:30px;' alt"blockchain"></span>
                                            <span><img src='img/extern_logo/discord_logo.png'
                                                       style='width:35px;'
                                                       alt"discord"> <?php echo $project['discordMemberNumber']; ?></span>
                                        </div>
                                        <a href="nft.php?id=<?php echo base64_encode($project['id']); ?>">Check this
                                            NFT</a>
                                    </div>
                                </div>
                            </a>
        ...
        <div class="row">
            ...
            <div class="swiper-container">
              ...
              15px 15px rgba(253, 156, 46, 0.3),
              20px 20px rgba(253, 156, 46, 0.2),
              25px 25px rgba(253, 156, 46, 0.1);"><strong
                                        style="position:absolute;color:white;margin:5px;text-shadow: 1px 0 0 #000, 0 -1px 0 #000, 0 1px 0 #000, -1px 0 0 #000;"><?php echo $projectExist['floorPrice'] ?></strong><img
                                        alt="<?php echo $projectExist['name'] ?>" class="img-fluid card-img-top"
                                        src="<?php echo $projectExist['thumbnail'] ?>">
                                    <div class="sample">
                                        <div class="ribbon down" style="--color: #fd9c2e;">
                                            <div class="content">
                                                <svg width="24px" height="24px" aria-hidden="true" focusable="false"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-bottom d-flex justify-content-between">
                                                <span><img src='img/extern_logo/twitter_logo.png'
                                                           style='width:40px;'
                                                           alt"twitter"> <?php echo $projectExist['twitterFollowerNumber']; ?></span>
                                            <span><img
                                                    src='img/extern_logo/crypto/<?php echo $projectExist['blockchain']; ?>.png'
                                                    style='width:30px;' alt"blockchain"></span>
                                            <span><img src='img/extern_logo/discord_logo.png'
                                                       style='width:35px;'
                                                       alt"discord"> <?php echo $projectExist['discordMemberNumber']; ?></span>
                                        </div>
                                        <a href="project.php?id=<?php echo base64_encode($projectExist['id']); ?>">Check
                                            this NFT</a>
                                    </div>
                                </div>
                            </a>
    ...
    padding-right: 15px;'>View All</a>
              ...
              25px 25px rgba(253, 156, 46, 0.1); ">
                                ...
                                <div class="card" style=" max-height: 700px; min-height: 500px; ">
                                    <?php } ?><img alt="<?php echo $project['name'] ?>" class="img-fluid card-img-top"
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="create-sell-content">
                                ...
                                <div>
                                    ...
                                    <p>All projects and drops on NFTDropCalendar are verified and legitimate, ensuring a
                                        safe and reliable experience for users.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="create-sell-content">
                                ...
                                <div>
                                    ...
                                    <p>NFTDropCalendar provides all the necessary information and tools for users to
                                        stay informed and make informed decisions.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="create-sell-content">
                                ...
                                <div>
                                    ...
                                    <p>Listing your own NFT project or drop on NFTDropCalendar will give it extra
                                        visibility and reach through our newsletter and social media channels.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="create-sell-content">
                                ...
                                <div>
                                    <h4>Free to Use</h4>
                                    <p>NFTDropCalendar is completely free to use for users, with a small fee for listing
                                        projects or drops.</p>
                                </div>
                            </div>
                        </div>
