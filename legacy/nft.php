    ...
    <?php if ($project['verified'] == 'false') { ?>
        <center>
            <div class="alert warning">
                <strong>Alert!</strong><br> Your project is private for now. We still need investigate everything and
                manually fill in some data before your project is public. We will do the investigation as soon as
                possible! (This will not take long)
            </div>
        </center>
    <?php } ?>
    <div class="container">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="countdown-times mb-3 card no-hover"
                                     style="padding: 1.5rem; margin-top: 2vh; font-size: 30px;">
                            ...
                            <div class="col-md-6">
                                ...
                                <a class="d-block btn btn-bordered mt-4" target="_blank"
                                   ...
                                   data-show-count="false" style="color: gray">
                                    <img src='img/extern_logo/discord_logo.png' alt="discord_logo" style='width:25px;'>
                                    Discord
                                    server</a>
                                <a class="d-block btn btn-bordered mt-4" target="_blank"
                                   href="<?php echo $project['websiteLink']; ?>" data-dnt="true"
                                   data-show-count="false" style="color: gray">
                                    <img src='img/extern_logo/link_icon.jpg' alt="website_link" style='width:25px;'>
                                    Website
                                    Link</a>
                            </div>
                        </div>
