                                    ...
                                    <div class="activity-content ml-4">
                                        ...
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <form action='reviewAppProjectProc.php' methode='get'>
                                                ...
                                                <input type='hidden'
                                                       value='<?php echo $project['twitterFollowerAmount']; ?>'
                                                       name='twitterFollowerAmount'>
                                                ...
                                                <div class='row'>
                                                    ...
                                                    <div class='col-2'>
                                                        ...
                                                        <a href='deleteProject.php?id=<?php echo base64_encode($project['id']); ?>'
                                                           style="background-color:red; color:white;">Delete</a>
                                                    </div>
                                                </div>
                                            </form>
                                            ...
                                            <form action='reviewAppUpdateProject.php' methode='get'>
                                                ...
                                                <div class='row'>
                                                    ...
                                                    <div class='col-2'>
                                                        ...
                                                        <a href='delete.php?idProj=<?php echo base64_encode($project['id']); ?>'
                                                           style="background-color:red; color:white;">Delete</a>
                                                    </div>
                                                </div>
                                            </form>
