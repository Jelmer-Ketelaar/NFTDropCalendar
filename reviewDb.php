...
<td><select name='verified'><option value='true' <?php if( $project['verified'] == 'true'){ ?>selected<?php } ?>>true</option><option value='false' <?php if( $project['verified'] == 'false'){ ?>selected<?php } ?>>false</option></select></td>
<td><input type='text' name='name' value='<?php echo $project['name']; ?>'></td>
<td><select name='blockchain'><option value='ethereum' <?php if( $project['blockchain'] == 'ethereum'){ ?>selected<?php } ?>>ethereum</option><option value='solana' <?php if( $project['blockchain'] == 'solana'){ ?>selected<?php } ?>>solana</option><option value='polygon' <?php if( $project['blockchain'] == 'polygon'){ ?>selected<?php } ?>>polygon</option><option value='cardano' <?php if( $project['blockchain'] == 'cardano'){ ?>selected<?php } ?>>cardano</option></select></td>
...
<td><input type='number' step='0.5' name='royality' value='<?php echo $project['royality']; ?>'></td>
